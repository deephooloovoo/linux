...
#define VIDCON0_2443					0x00
#define VIDCON0_2443_VIDOUT_MASK			(0x3 << 22)
#define VIDCON0_2443_VIDOUT_SHIFT			22
#define VIDCON0_2443_VIDOUT_RGB			(0x0 << 22)
#define VIDCON0_2443_VIDOUT_I80_LDI0			(0x2 << 22)
#define VIDCON0_2443_VIDOUT_I80_LDI1			(0x3 << 22)

#define VIDCON0_2443_L1_DATA_MASK			(0x7 << 19)
#define VIDCON0_2443_L1_DATA_SHIFT			19
#define VIDCON0_2443_L1_DATA_16BPP			(0x0 << 19)
#define VIDCON0_2443_L1_DATA_18BPP16			(0x1 << 19)
#define VIDCON0_2443_L1_DATA_18BPP9			(0x2 << 19)
#define VIDCON0_2443_L1_DATA_24BPP			(0x3 << 19)
#define VIDCON0_2443_L1_DATA_18BPP			(0x4 << 19)

#define VIDCON0_2443_L0_DATA_MASK			(0x7 << 16)
#define VIDCON0_2443_L0_DATA_SHIFT			16
#define VIDCON0_2443_L0_DATA_16BPP			(0x0 << 16)
#define VIDCON0_2443_L0_DATA_18BPP16			(0x1 << 16)
#define VIDCON0_2443_L0_DATA_18BPP9			(0x2 << 16)
#define VIDCON0_2443_L0_DATA_24BPP			(0x3 << 16)
#define VIDCON0_2443_L0_DATA_18BPP			(0x4 << 16)

#define VIDCON0_2443_PNRMODE_MASK			(0x3 << 13)
#define VIDCON0_2443_PNRMODE_SHIFT			13
#define VIDCON0_2443_PNRMODE_RGB			(0x0 << 13)
#define VIDCON0_2443_PNRMODE_BGR			(0x1 << 13)
#define VIDCON0_2443_PNRMODE_SERIAL_RGB		(0x2 << 13)
#define VIDCON0_2443_PNRMODE_SERIAL_BGR		(0x3 << 13)

#define VIDCON0_2443_CLKVALUP			(1 << 12)
#define VIDCON0_2443_CLKVAL_F_MASK			(0x3f << 6)
#define VIDCON0_2443_CLKVAL_F_SHIFT			6
#define VIDCON0_2443_CLKVAL_F_LIMIT			0x3f
#define VIDCON0_2443_CLKVAL_F(_x)			((_x) << 6)
#define VIDCON0_2443_VLCKEN			(1 << 5)
#define VIDCON0_2443_CLKDIR				(1 << 4)

#define VIDCON0_2443_CLKSEL_MASK			(0x3 << 2)
#define VIDCON0_2443_CLKSEL_SHIFT			2
#define VIDCON0_2443_CLKSEL_HCLK			(0x0 << 2)
#define VIDCON0_2443_CLKSEL_LCD			(0x1 << 2)

#define VIDCON0_2443_ENVID				(1 << 1)
#define VIDCON0_2443_ENVID_F				(1 << 0)
